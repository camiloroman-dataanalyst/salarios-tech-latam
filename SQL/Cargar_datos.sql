...
LOAD DATA LOCAL INFILE 'C:/Users/CAMILO/Desktop/stack-overflow-developer-survey-2025/survey_results_public.csv'
INTO TABLE survey
...
@c73,@c74,@c75,@c76,@c77,@c78,@c79,@c80,@c81,@c82,@c83,@c84,@c85,@c86,
...
@c161,@c162,@c163,@c164,@c165,@c166,@c167,@c168,@c169,@c170,@c171,@c172)
SET
    response_id = @c1,
    age = NULLIF(@c3, 'NA'),
    ed_level = NULLIF(@c4, 'NA'),
    employment = NULLIF(@c5, 'NA'),
    years_code = NULLIF(@c12, 'NA'),
    dev_type = NULLIF(@c13, 'NA'),
    remote_work = NULLIF(@c16, 'NA'),
    industry = NULLIF(@c42, 'NA'),
    country = NULLIF(@c62, 'NA'),
    language_worked_with = NULLIF(@c66, 'NA'),
    converted_comp_yearly = NULLIF(NULLIF(@c171, 'NA'), ''),
    job_sat = NULLIF(@c172, 'NA');
